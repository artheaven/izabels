...
export default function BouquetCategoriesPage() {
  ...
  const loadCategories = async () => {
    try {
      ...
      setCategories(response.data.categories.filter((c: any) => c.type === 'BOUQUET'));
    } catch (error) {
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <h1 className="text-3xl font-bold">Категории на букетите</h1>
        </div>
        {!showForm && (
          <button
